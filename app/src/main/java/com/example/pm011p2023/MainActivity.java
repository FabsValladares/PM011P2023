...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*encontrar el objeto por su id ligando objeto usuario con objeto logico*/
    ...
    private void MostrarCliente() {
        String Mensaje = nombres.getText().toString() + "-" + apellidos.getText().toString() + "-" + correo.getText().toString();
